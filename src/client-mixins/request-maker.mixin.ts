...
import {
    IClientSettings, ITwitterApiClientPlugin, TClientTokens, TwitterApiPluginResponseOverride,
    TwitterRateLimit, TwitterResponse
} from '../types';
...
export class ClientRequestMaker {
  ...
  /** @deprecated - Switch to `@bun-x-api/plugin-rate-limit` */
  ...
  protected getHttpRequestArgs({
    ...
    if (!headers['x-user-agent']) {
      headers['x-user-agent'] = 'Node.bun-x-api';
    }
